<?php
		...
		$query = "Insert into takeoverdetails (Technician's Name,Technician's Id,Item Id,Item Name,Amount,Date,Time) values ('$techid','$techname', '$itemid', '$itemname','amount','date','time')" ;

		$result=mysql_query($query)or die("cound not insert values to database".mysql_error());
			
		if($result==true){
			echo "Successfully take overed";
		}
		else
